...
window.addEvent('domready', function(){	var menu = new Openmoomenu('ul.topnav', {delay: 400,animate: {props: ['opacity', 'width', 'height'], options: {duration: 700,fps: 100,transition: 'expo:out'}} }); });
