...
function template_show_month_grid($grid_name)
{
	...
	if (empty($calendar_data['disable_title']))
	{
		echo '
			<div class="cat_bar">
				<h3 class="catbg" style="font-size: ', $calendar_data['size'] == 'large' ? 'large' : 'small', ';">';
		...
		if ($calendar_data['show_next_prev'])
			echo '<div class="header">', $txt['months_titles'][$calendar_data['current_month']], ' ', $calendar_data['current_year'], '</div>';
		else
			echo '
...
function template_show_week_grid($grid_name)
{
	...
	foreach ($calendar_data['months'] as $month_data)
	{
		...
		echo '
					<a href="', $scripturl, '?action=calendar;month=', $month_data['current_month'], ';year=', $month_data['current_year'], '">', $txt['months_titles'][$month_data['current_month']], ' ', $month_data['current_year'], '</a>', empty($done_title) && !empty($calendar_data['week_number']) ? (' - ' . $txt['calendar_week']
